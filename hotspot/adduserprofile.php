        ...
        <form autocomplete="off" method="post" action="">
          ...
          <table class="table">
            ...
            <tr>
              ...
              <td><input class="form-control" type="text" size="4" autocomplete="off" name="sharedusers" value="1" required="1"></td>
            </tr>
            <tr>
              <td class="align-middle">Rate limit [up/down]</td>
              <td><input class="form-control" type="text" name="ratelimit" autocomplete="off" value="" placeholder="Example : 512k/1M"></td>
            </tr>
            <tr>
            ...
            <tr id="validity" style="display:none;">
              ...
              <td><input class="form-control" type="text" id="validi" size="4" autocomplete="off" name="validity" value="" required="1"></td>
            </tr>
            <tr id="graceperiod" style="display:none;">
              <td class="align-middle"><?= $_grace_period ?></td>
              <td><input class="form-control" type="text" id="gracepi" size="4" autocomplete="off" name="graceperiod" placeholder="5m" value="5m" required="1"></td>
            </tr>
            <tr>
              <!-- <td class="align-middle"><?= $_price . ' ' . $currency; ?></td> -->
              <td>
                <input class="form-control" type="hidden" min="0" name="price" value="0">
              </td>
            </tr>
            <tr>
              <!-- <td class="align-middle"><?= $_selling_price . ' ' . $currency; ?></td> -->
              <td><input class="form-control" type="hidden" size="10" min="0" name="sprice" value="0"></td>
            </tr>
            <tr>
              <td><?= $_lock_user ?></td>
              <td>
