...
<script>
  ...
  var _0x7baa = ["\x63\x6C\x69\x63\x6B", "\x2E\x70\x72\x69\x6E\x74\x42\x54", "\x72\x65\x61\x64\x79"];
  $(document)[_0x7baa[2]](function() {
    $(_0x7baa[1])[_0x7baa[0]](function() {
      printBT()
    })
  })
</script>
<div class="row">
  ...
  <div class="card">
    <div class="card-header">
      <h3><i class="fa fa-edit"></i> <?php echo $_edit_user . ' ' . $uname . ' ';
                                      if ($utimelimit == "1s") {
                                        echo $_expired;
                                      } ?></h3>
    </div>
      ...
      <form autocomplete="new-password" method="post" action="">
        ...
        <table class="table">
          ...
          <tr>
            ...
            <td><input id="name" class="form-control" type="text" autocomplete="off" name="name" value="<?= $uname; ?>"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input class="form-control" type="text" value="<?= $umac; ?>"></td>
          </tr>
          <tr>
            <td class="align-middle">Uptime</td>
            <td><input class="form-control" type="text" value="<?php if ($uuptime == 0) {
                                                                } else {
                                                                  echo $uuptime;
                                                                } ?>" disabled></td>
          </tr>
          <tr>
            <td class="align-middle">Bytes In / Out</td>
            <td><input class="form-control" type="text" value="<?php if ($ubytesout == 0) {
                                                                } else {
          ...
          <tr>
            ...
            <td><input id="timelimit" class="form-control" type="text" size="4" autocomplete="off" name="timelimit" value="<?php if ($utimelimit == "1s") {
                                                                                                                              echo "";
                                                                                                                            } else {
                                                                                                                              echo $utimelimit;
                                                                                                                            } ?>"></td>
          ...
          <tr>
            ...
            <td><input class="form-control" type="text" id="comment" autocomplete="off" name="comment" title="No special characters" value="<?= $ucomment; ?>" <?= $commt ?>><input type="hidden" name="h_comment" value="<?= $ucomment ?>"></td>
          </tr>
          <tr>
          <tr <?= $display ?>>
            <td class="align-middle"><?= $_tcomment2 ?></td>
            <td><input class="form-control" type="<?= $comment2t; ?>" id="comment2" autocomplete="off" name="comment2" title="No special characters" value="<?= $ucomment2; ?>"></td>
          </tr>
          <!-- <tr>
    ...
    <td class="align-middle"><?= $_selling_price ?></td><td><input class="form-control" id="price" type="text" value="<?php if ($getprice == 0) {
          ...
          <?php if ($getvalid != "") { ?>
            <tr>
              ...
              <td><input class="form-control" type="text" id="validity" value="<?= $getvalid; ?>" disabled></td>
            </tr>
          <?php
          } else {
          } ?>
