...
<?php if ($id != "") { ?>
  ...
  <div id="navbar" class="navbar">
    <div class="navbar-left">
      <a id="brand" class="text-center " style=" visibility: hidden;" href="javascript:void(0)">MIKHMON</a>
...
<?php
  ...
  <div id="navbar" class="navbar">
    <div class="navbar-left">
      <a id="brand" class="text-center" style=" visibility: hidden;" href="./?session=<?= $session; ?>">MIKHMON</a>
