    ...
    <div class="card">
      ...
      <div class="card-body">
        <form autocomplete="off" method="post" action="">
          ...
          <table class="table">
            <tr>
              <td><?= $_name ?> <i class="fa fa-ci fa-circle <?= $moncolor ?>"></i></td>
            ...
            <tr>
              <td>Shared Users</td>
              <td><input class="form-control" type="text" size="4" autocomplete="off" name="sharedusers" value="<?= $psharedu; ?>" required="1"></td>
            </tr>
            <tr>
              <td>Rate limit [up/down]</td>
              <td><input class="form-control" type="text" name="ratelimit" autocomplete="off" value="<?= $pratelimit; ?>" placeholder="Example : 512k/1M"></td>
            </tr>
            <tr>
              <td><?= $_expired_mode ?></td>
              <td>
            ...
            <tr id="validity" <?php if ($getexpmodet == "None") {
                                echo 'style="display:none;"';
                              } ?>>
              <td><?= $_validity ?></td>
              <td><input class="form-control" type="text" id="validi" size="4" autocomplete="off" name="validity" value="<?= $getvalid; ?>" required="1"></td>
            </tr>
            <!-- <tr> -->
              <!-- <td><?= $_price . " " . $currency; ?></td> -->
              <!-- <td> -->
            ...
            <!-- <tr>
              ...
              <td> -->
                <input class="form-control" type="hidden" size="10" min="0" name="sprice" value="0">
              <!-- </td>
            </tr> -->
            <tr>
              <td><?= $_lock_user ?></td>
